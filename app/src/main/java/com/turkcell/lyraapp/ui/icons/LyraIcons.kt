...
object LyraIcons {
    ...
    val Shuffle: ImageVector by lazy {
        lyraIcon(
            name = "Shuffle",
            pathData = "M10.59,9.17L5.41,4 4,5.41l5.17,5.17 1.42,-1.41zM14.5,4l2.04,2.04L4,18.59 5.41,20 17.96,7.46 20,9.5V4h-5.5zM14.83,13.41l-1.41,1.41 3.13,3.13L14.5,20H20v-5.5l-2.04,2.04-3.13,-3.13z",
        )
    }
    ...
    val Clock: ImageVector by lazy {
        lyraIcon(
            name = "Clock",
            pathData = "M12,2C6.5,2,2,6.5,2,12s4.5,10,10,10,10-4.5,10-10S17.5,2,12,2zm0,18c-4.4,0-8-3.6-8-8s3.6-8,8-8,8,3.6,8,8-3.6,8-8,8zm.5-13H11v6l5.2,3.2,.8-1.3-4.5-2.7V7z",
        )
    }
    ...
    val Sync: ImageVector by lazy {
        lyraIcon(
            name = "Sync",
            pathData = "M12,4V1L8,5l4,4V6c3.3,0,6,2.7,6,6c0,1-.2,2-.7,2.8l1.5,1.5C19.6,15.1,20,13.6,20,12C20,7.6,16.4,4,12,4zm-6,8c0-1,.2-2,.7-2.8L5.2,7.7C4.4,8.9,4,10.4,4,12c0,4.4,3.6,8,8,8v-3l4,4l-4,4v-3C7.6,20,4,16.4,6,12z",
        )
    }
